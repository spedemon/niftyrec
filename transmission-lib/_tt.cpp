...
//        fprintf(stderr,"\n----> %f %f - %f %f %f - %f %f %f ",detector_size[proj].x,detector_size[proj].y,detector_transl[proj].x,detector_transl[proj].y,detector_transl[proj].z,detector_rotat[proj].x,detector_rotat[proj].y,detector_rotat[proj].z);
        ...
        if (use_gpu)
        {
            ...
            tt_backproject_ray_kernel(gridSize, blockSize, d_current_projection, d_output, detectorPixels, sourcePosition, volumeVoxels, volumeSize, t_step, interpolation);

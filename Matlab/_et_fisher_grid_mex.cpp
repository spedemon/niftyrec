...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
   ...
   status = et_array_fisher_grid(activity_ptr, activity_size, cameras_ptr, cameras_size, psf_ptr, psf_size, grid_ptr, fisher_ptr, fisher_size, attenuation_ptr, attenuation_size, epsilon, background, background_attenuation, enable_gpu);

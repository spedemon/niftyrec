   ...
   switch(dim_sino)
      ...
      case 3:
           ...
           if (!no_psf)
               ...
               if (psf_size[0]%2!=1 || psf_size[1]%2!=1 || psf_size[2]!=sino_size[1])
                    mexErrMsgTxt("Point Spread Function must be of size hxkxN for Activity of size NxNxm; h,k odd.");
               }
           bkpr_size[0] = sino_size[0];
           bkpr_size[1] = sino_size[0];
           bkpr_size[2] = sino_size[1];
           break;        
      default:

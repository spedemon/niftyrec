...
extern "C" int PET_project_compressed(
                           ...
                           float *angles_axial, float *angles_azimuthal,  
...
if (0) {    
    ...
    fprintf(stderr,"  - angles_axial:                 "); 
    for (int i=0; i<*N_axial; i++) 
        fprintf(stderr,"%f ",angles_axial[i]); 
    fprintf(stderr,"\n"); 
    fprintf(stderr,"  - angles_azimuthal:             "); 
    for (int i=0; i<*N_azimuthal; i++) 
        fprintf(stderr,"%f ",angles_azimuthal[i]); 
    fprintf(stderr,"\n"); 
}
	...
	*m = reg_mat44_mul(rotation_m, m);
    ...
    if (*use_gpu)
        status = PET_project_compressed_gpu(activityImage, attenuationImage, projection, 
                                            ...
                                            angles_axial, angles_azimuthal, *N_u, *N_v, *size_u, *size_v, 
